...
// For many applications you want to load a model or asset at run time so this demo uses
// https://sotrh.github.io/learn-wgpu/beginner/tutorial4-buffer/
// to tweak the demo from static values in the shaders to static values shared with the shader.
// This is less efficient but needed fore more flexible setups
...
// SAFETY This is probably true because or repr(C)
unsafe impl bytemuck::Pod for Vertex {}
// SAFETY This is true as all zeros are valid floats
